...
public class CrowdForm extends JFrame {
	...
	private void initComponent() {
		...
		sexComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Men", "Women" }));
		...
		btnSave.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent evt) {
				if (isValidFisrtName() & isValidLastName() & isValidMail()
					...
					crowd.setSex(sexComboBox.getSelectedItem().toString().charAt(0));
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
								.addComponent(passTextField, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
								.addComponent(loginTextField, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
								.addComponent(emailTextField, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
								.addComponent(phoneTextField, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
								.addComponent(AdressTextField)
								.addComponent(birthDateChooser, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE)
								.addComponent(lastNameTextField)
								.addComponent(firstNameTextField, GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE)
								.addComponent(sexComboBox, Alignment.TRAILING, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
							.addGap(17)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addComponent(lastNameError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(firstNameError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(sexError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(birthDateError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(adressError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(phoneError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(emailError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(loginError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
								.addComponent(passError, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)))
						.addComponent(separator, GroupLayout.DEFAULT_SIZE, 401, Short.MAX_VALUE)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(112)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(lblSex, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE)
						.addComponent(label_1))
					.addGap(18)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(lblBirthDate)
							.addComponent(birthDateError)
							.addComponent(label_2))
						.addComponent(birthDateChooser, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(12)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblAdress)
	...
	private boolean isValidPass() {
		if (FieldVerifier.VerifComplexField(passTextField.getText(), 3)) {
			...
			passTextField.setText(FieldVerifier.getErrorMsg());
	...
	private boolean isValidMail() {
		if (!modif) {
			if (FieldVerifier.VerifOrdinaryField(emailTextField.getText())) { // mailTextfield.getText().length()
																				// >
				if (FieldVerifier
			...
			if (FieldVerifier.VerifOrdinaryField(emailTextField.getText())) { // mailTextfield.getText().length()
																				// >
				if (FieldVerifier.VerifComplexField(emailTextField.getText(),
						crowd.getEmail(), 2)) {
					emailError.setVisible(false);
					return true;
				} else {
